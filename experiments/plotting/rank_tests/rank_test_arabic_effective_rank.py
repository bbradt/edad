...
if os.path.exists("experiments/full_dfs/rank_test_arabic.csv"):
    ...
    df.to_csv("experiments/full_dfs/rank_test_arabic_new.csv", index=False)
...
plt.title("GRU - Effective Rank - Max Rank=10")
plt.ylabel("Effective Rank - Mean over batches")
plt.legend(["Output Layer", "FC"])
plt.savefig("figures/rank_test_arabic_effective_rank.png", bbox_inches="tight")
