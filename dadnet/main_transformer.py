from model.transformer import CTransformerEncoderDecoder
import model.transformer_util as util

from model.transformer_util import d, here
...
def go(arg):
    ...
    site_opt = []
    for site in range(2):
        model = CTransformerEncoderDecoder(
