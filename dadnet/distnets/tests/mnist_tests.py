...
def run_edad(
    ...
    train_1, train_2 = random_split(train_data, 2)
    ...
    edad_net = TeDadNet(model1, model2)
    ...
    for e in range(epochs):
        ...
        for i, (batch_1, batch_2) in enumerate(zip(dataloader_1, dataloader_2)):
            ...
            yhats = edad_net.forward(data_1, data_2)
            loss = edad_net.backward([label_1, label_2], yhats, nn.CrossEntropyLoss)
            # edad_net.aggregate()
