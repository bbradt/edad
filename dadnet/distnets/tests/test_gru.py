...
if __name__ == "__main__":
    torch.manual_seed(0)
    x1 = torch.randn(8, 256, 2)
    y1 = torch.randint(0, 10, (8,))
    x2 = torch.randn(8, 256, 2)
    ...
    torch.manual_seed(0)
    np.random.seed(0)
    model1_pooled = GRUEncoderDecoder(x1.shape, 10)
    torch.manual_seed(0)
    np.random.seed(0)
    ...
    torch.manual_seed(0)
    np.random.seed(0)
    model1_dsgd = GRUEncoderDecoder(x1.shape, 10)
    torch.manual_seed(0)
    np.random.seed(0)
    model2_dsgd = GRUEncoderDecoder(x1.shape, 10)
    ...
    torch.manual_seed(0)
    np.random.seed(0)
    model1_dad = GRUEncoderDecoder(x1.shape, 10)
    torch.manual_seed(0)
    np.random.seed(0)
    model2_dad = GRUEncoderDecoder(x1.shape, 10)
    ...
    torch.manual_seed(0)
    np.random.seed(0)
    model1_edad = GRUEncoderDecoder(x1.shape, 10)
    torch.manual_seed(0)
    np.random.seed(0)
    model2_edad = GRUEncoderDecoder(x1.shape, 10)
